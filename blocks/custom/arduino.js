...
Blockly.Blocks['controls_delay'] = {
  ...
  init: function () {
      ...
      var xy = workspace.getSvgXY(this.getSvgRoot());
      var ripple = Blockly.utils.dom.createSvgElement(
        Blockly.BlockSvg('circle'),
        {
          'cx': xy.x,
          'cy': xy.y,
          'r': 0,
...
Blockly.Blocks['serial_println'] = {
  init: function () {
      ...
      this.appendValueInput("CONTENT")
          .setCheck(["Number", "String"])
          .appendField('SERIAL print line OWIEOWIEOWIEOWIE');
...
Blockly.Blocks['sandwich'] = {init: function () {
      this.setColour('#f92f2f');
      this.appendValueInput("CONTENT")
        .setCheck(["Number"])
        .appendField('sandwich?');
      this.setPreviousStatement(true);
      this.setNextStatement(true);
      this.setTooltip('sandwich.');
  }
};
